...
MACRO_CONFIG_INT(TcAiBotSafeFreezeEscapeDelay, tc_aibot_safe_freeze_escape_delay, 50, 1, 250, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Ticks AIBot gives a freeze drop route to reach its safe platform before restarting")
